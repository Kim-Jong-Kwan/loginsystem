...
d1.set_img(0,{imgtitle:"요구사항명세",imgurl:"https://drive.google.com/file/d/1NXPYGbGZHcReeObo66VbO6OC_yKTkso_/view?usp=drive_link",imglog:"사용자의 요구사항을 인터뷰, 설문지등의 방법으로 조사하여 분석할 수 있다.",sourceurl:"https://docs.google.com/document/d/1XNXs3RtvmnQse-aab8kzT8fyae8Pdo0CwJQDUqQy8xo/edit?tab=t.0"})//이미지타이틀


d1.set_content("목표 시스템 개발을 위한 적정한 언어를 선정하고 라이선스와 향후 지원사항을 참고하여 결정한다.")
d1.set_img(1,{imgtitle:"개발언어선정",imgurl:"https://drive.google.com/file/d/15GgAeFgW1Cxctk9PbJagUNfG2UkEU4WS/view?usp=drive_link",imglog:"자바언어기반 스프링프레임워크, html5, memberData file",sourceurl:"https://docs.google.com/document/d/138SKROLZF96D9M_wtCWwvm1bL0mHPlvQGdsVBq_44wg/edit?pli=1&tab=t.0"})//이미지타이틀
...
d1.set_img(2,{imgtitle:"개발환경 구축 명세",imgurl:"https://drive.google.com/file/d/1mw6ZBtTbbZQYlfz1YQXCuTfoi-hnvfpg/view?usp=drive_link",imglog:"운영체제 및 개발에 필요한 환경을 고려하여 개발도구, 테스트도구, 빌드도구, 패키징도구, 형상관리도구등을 결정",sourceurl:"https://docs.google.com/document/d/1kGycWLx2GM-TEnmE2LCVFvvBeCvjc_kE5xQKBbRzS5E/edit?tab=t.0"})//이미지타이틀
